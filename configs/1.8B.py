...
TRAIN_FOLDER = "/mnt/petrelfs/quwenwen/0623_scratch_tokenized_filtered/train/"
VALID_FOLDER = "/mnt/petrelfs/quwenwen/0623_scratch_tokenized_filtered/train/"
data = dict(
    seq_len=SEQ_LEN,
...
model = dict(
    ...
    moe_type="Mixtral-DMOE",  # moe_type can be "Naive", "GShard", "Mixtral", "Mixtral-DMOE"
)
